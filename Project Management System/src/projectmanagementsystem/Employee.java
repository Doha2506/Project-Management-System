...
public class Employee extends Characteristics {
   ...
   public Employee(String name,int id,double salary,String dept){
    ...
    double getWorkingHoursOverMonth(){ // calculate working hours over month.
        long workingHours = exitTime - entryTime;   // working hours in milliseconds over day
    ...
    // get working hours ( Doha )
    public static String getHours(int id,String name) throws IOException{
    ...
    //request vacation ( Doha )
   public static boolean requestVacation(int id,String name) throws IOException{
        if(checkExistenceOfEmployee(id,name) == true){
    ...
    public static boolean modifyFile(String oldContent,String newContent) throws IOException {
        try{ 
            String line = "";
            Scanner input = new Scanner(file);
...
//                + this.getName() + "\t" 
//                + this.getDepartment() + "\t" 
//               // + this.getVacationLeftThisYear()+ "\t " 
//                + this.getSalary() +"\t";
//               // + this.getWorkingHoursOverMonth();
//    } 
//    
